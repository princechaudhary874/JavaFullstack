...
public class NetworkingServerProject{
	...
	public void showTableData(){
		...
		try{
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/studentv3","root","12345");
	...
	public void run(){
		...
		try{
			while(true){
                ...
                String sql = "insert into student(firstName, middleName, lastName, whatsappNo, mobileNo, schoolName, classNo, collegeName, branch, sem)"
							+ "value (?,?,?,?,?,?,?,?,?,?)";

				System.out.println(sql);
				System.out.println(p1.s_fname + p1.s_mname +p1.s_class+p1.mno);

				c = DriverManager.getConnection("jdbc:mysql://localhost:3306/studentV3","root","student");
